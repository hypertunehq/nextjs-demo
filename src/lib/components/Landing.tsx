  ...
  return (
    <main className="flex min-h-screen flex-col bg-gradient-to-b from-intent-primary to-intent-success text-white">
      ...
      <header className="flex w-full items-center justify-between px-6 py-4">
        <div className="flex flex-row items-center gap-2 text-2xl font-semibold text-white/95">
      ...
      <section className="flex flex-col items-center justify-center px-6 py-20 text-center">
        <div className={`flex ${layout === "vertical" ? "flex-col" : "flex-row"} items-center justify-center gap-6`}>
          <h1 className="max-w-5xl text-6xl font-extrabold tracking-tight sm:text-[5rem]">
            {headline}
          </h1>
        </div>
        <p className="mt-4 max-w-3xl text-xl text-white/90">
          The connected workspace where teams create docs, plan projects, organize knowledge, and collaborate in real-time—all in one place.
        </p>
        <div className="mt-8">
          <Link
      ...
      <section className="px-6 py-16">
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-xl border border-white/10 bg-white/10 p-6 backdrop-blur-md">
            ...
            <p className="mt-2 text-white/90">Collaborate on documents, tasks, and wikis with real‑time editing and comments.</p>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/10 p-6 backdrop-blur-md">
            <h3 className="text-2xl font-semibold">Stay organized</h3>
            <p className="mt-2 text-white/90">Flexible pages, databases, and views to keep everything searchable and structured.</p>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/10 p-6 backdrop-blur-md">
            <h3 className="text-2xl font-semibold">Move faster with AI</h3>
            <p className="mt-2 text-white/90">Summarize notes, draft docs, and generate action items directly in your workspace.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 pb-16">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl" style={{ fontWeight: 700 }}>Features</h2>
          <ul className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <li className="rounded-lg border border-white/10 bg-white/10 p-5">
              ...
              <p className="mt-1 text-white/90">Capture knowledge with rich text, embeds, and simple organization.</p>
            </li>
            <li className="rounded-lg border border-white/10 bg-white/10 p-5">
              <h4 className="text-xl font-semibold">Tasks & projects</h4>
              <p className="mt-1 text-white/90">Plan sprints, assign tasks, and track progress with databases and views.</p>
            </li>
            <li className="rounded-lg border border-white/10 bg-white/10 p-5">
              <h4 className="text-xl font-semibold">Templates</h4>
              <p className="mt-1 text-white/90">Start quickly with pre‑built pages for roadmaps, notes, and more.</p>
            </li>
            <li className="rounded-lg border border-white/10 bg-white/10 p-5">
              <h4 className="text-xl font-semibold">Integrations</h4>
              <p className="mt-1 text-white/90">Connect your tools to keep work in sync—calendar, chat, and more.</p>
            </li>
          </ul>
        </div>
      </section>
      ...
      <footer className="mt-auto border-t border-white/10 bg-black/10 px-6 py-8">
        <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 md:grid-cols-4">
          <div>
            ...
            <ul className="mt-2 space-y-1 text-white/90">
              ...
              <li><Link href="/app/plans">Plans</Link></li>
              <li><Link href="/app/team">Team</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mx-auto mt-6 max-w-6xl text-sm text-white/70">© {new Date().getFullYear()} Potion. All rights reserved.</div>
      </footer>
    </main>
  );
}
