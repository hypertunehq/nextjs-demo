...
export default function CreateProject({
  ...
  const handleCreate = () => {
    ...
    const newProject = {
      ...
      image:
        `https://picsum.photos/seed/${encodeURIComponent(trimmed)} /800/400`.replace(
          ' %2F',
          ''
        ),
    }
    ...
    <>
      ...
      <Modal
        ...
        primaryAction={{
          ...
          disabled: trimmedName.length === 0 || isNameInvalid,
        }}
          ...
          <input
            className={
              ...
              (isNameInvalid
                ...
                : 'border-bd-darker focus:border-intent-primary')
            }
