...
const initialProjects: Project[] = [
  {
    ...
    image: 'https://picsum.photos/seed/portal/800/400',
  },
  {
    id: 'p2',
    name: 'Analytics Dashboard',
    description: 'Realtime charts with WebSockets',
    image: 'https://picsum.photos/seed/analytics/800/400',
  },
  {
    id: 'p3',
    name: 'Mobile App Backend',
    description: 'tRPC API for React Native',
    image: 'https://picsum.photos/seed/backend/800/400',
  },
  {
    id: 'p4',
    name: 'Marketing Site',
    description: 'Static pages with CMS',
  ...
  },
  {
    ...
    description: 'Email & push pipeline',
    image: 'https://picsum.photos/seed/notifications/800/400',
  },
  {
    id: 'p7',
    name: 'Admin Console',
  ...
  },
  {
    id: 'p8',
    name: 'Data Lake',
    description: 'ETL to S3 + Athena',
    image: 'https://picsum.photos/seed/datalake/800/400',
  },
  {
    id: 'p9',
    name: 'Design System',
  ...
  },
  {
    ...
    image: 'https://picsum.photos/seed/billing/800/400',
  },
]
...
export default function ProjectsClient(): React.ReactElement | null {
  ...
  return (
    <div className="flex flex-col gap-3">
      {showBanner && (
        <div className="relative mb-6 w-full rounded-lg border border-intent-primary/30 bg-intent-primary/5 p-4 text-intent-primary">
          <button
            type="button"
            aria-label="Dismiss"
          ...
          <div className="mt-2 text-md text-tx-default">
            Manage and track all your projects in one place. Create a new
      ...
      <ul className="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-4">
        {projects.map((project) => (
          <li
            key={project.id}
            className="border-gray-200 dark:border-gray-800 dark:bg-gray-900 aspect-square overflow-hidden rounded-lg border bg-white p-4 shadow-sm transition hover:-translate-y-[2px] hover:border-bd-darker hover:shadow-md"
          >
