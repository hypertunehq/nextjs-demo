...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in Hypertune UI]({@link https://app.hypertune.com/projects/3652/main/draft/logic?selected_field_path=root%3EenableAIRecommendation})
   */
  enableAIRecommendation({ args = {}, fallback }: { args?: EmptyObject; fallback: boolean; }): boolean {
    const props0 = this.getFieldNodeProps("enableAIRecommendation", { fieldArguments: args });
    const expression0 = props0.expression;
...
const sourceFallback = {root:{enableAIRecommendation:false,ai:{loadingMessage:"",featureSuggestionPrompt:{model:"gpt_4o",messages:[],temperature:{value:0,isNull:false},topP:{value:0,isNull:false},topLogprobs:{value:0,isNull:false},presencePenalty:{value:0,isNull:false},maxTokens:{value:0,isNull:false},maxCompletionTokens:{value:0,isNull:false}}},landing:{headline:"",layout:"vertical"},events:{thumbsDown:false,thumbsUp:false,pageView:false,signUp:false,upgrade:false},discounts:[],price:0,featureGrid:[]}};
